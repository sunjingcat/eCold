...
import com.zz.cold.business.mine.AboutActivity;
import com.zz.cold.net.ApiService;
import com.zz.cold.net.JsonT;
import com.zz.cold.net.RequestObserver;
import com.zz.cold.net.RxNetUtils;
import com.zz.cold.widget.CustomDialog;
import com.zz.cold.widget.UploadDialog;
...
//        location = Environment.getExternalStorageDirectory() + "/";
    ...
    private void updateVersion() {
        //网络请求
        RxNetUtils.request(RxNetUtils.getApi(ApiService.class).getVersion(), new RequestObserver<JsonT<Version>>() {
            @Override
